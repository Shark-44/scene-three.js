...
class Scene {
    ...
    addTooltip (point) { 
        ...
        // b)  fonction pour enlever la scene
        sprite.onClick = () => {
            this.destroy()
        }
    }

    // a) methode pour supprimer la scene en cours
    destroy () {
        // animation pour enlever la scene
        ...
        // animation pour supprimer la sprite
        this.sprites.forEach((sprite) => {
            sprite.material.transparent = true;  // Ajout de la transparence au material du sprite
            gsap.to(sprite.material, {          // Animation du material plutôt que scale
                duration: 1,
                opacity: 0,
                onComplete: () => {
...
function onClick(e) {
    ...
    intersects.forEach(function(intersect) {
        if (intersect.object.type === 'Sprite') {
            intersect.object.onClick() // permet d'executer la fonction dans la class scene
        }
    })
}
