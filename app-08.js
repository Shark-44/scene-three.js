...
const rayCaster = new THREE.Raycaster(); // pour etre utilisé ailleurs
...
function onClick (e) {
    ...
    // const rayCaster = new THREE.Raycaster(); la fonction est generalisée
...
// meme fonction que le onclick mais au survol
...
container.addEventListener('mousemove', onMouseMouve) // nouvelle fontion quand la souris survole la sprite